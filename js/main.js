...
$(document).on('ready', function () {
	...
	$('#button-download').on('click', function convert_HTML_to_PDF() {
        ...
        //     '#page-loader': function (element, renderer) {
        //         // true = "handled elsewhere, bypass text extraction"
        //         return true
		// 	},
        //     '#navbarMenu': function (element, renderer) {
        //         // true = "handled elsewhere, bypass text extraction"
        //         return true
		// 	},
        //     '#article-slider': function (element, renderer) {
        //         // true = "handled elsewhere, bypass text extraction"
        //         return true
		// 	},
